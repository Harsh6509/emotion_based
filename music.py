...
def recommend_songs():
    ...
    songs = {
        ...
        'angry': [
            "https://www.youtube.com/embed/ffxKSjUwKdU",
            "https://www.youtube.com/embed/eVTXPUF4Oz4"
        ],
        'surprise': [
            "https://www.youtube.com/embed/FzG4uDgje3M"
        ],
        'neutral': [
    ...
    selected_list = songs.get(emotion, songs['neutral'])
    # choose first one for simplicity
    url = selected_list[0]
